...
export interface IChartingLibraryWidget {
   ...
   *
   * @param index Zero based index.tsx of the chart.
  ...
  /**
   * Get the index.tsx of the active chart in the layout.
   *
   * @returns number.
   */
   ...
   * If an invalid index.tsx is supplied (less than zero, or greater than the number of charts minus 1)
   * then this method will not change the active chart.
   * @param index - index.tsx of chart to set as the active chart. Index is zero-based.
   */
...
export interface IContext {
   ...
   * @param  {number} i - the index.tsx of the symbol (`0` for the main series)
   */
...
export interface IPaneApi {
  ...
  /** Returns the pane's index.tsx, it's a number between 0 and all panes count - 1 */
  paneIndex(): number;
...
export interface IPineSeries {
  /**
   * Get the value at a specific index.tsx.
   *
   ...
   * - s.get(2) - third last
   * - and so on
   * @param  {number} n? - index.tsx
   */
  get(n?: number): number;
  /**
   * Set the value for the pine series at the current index.tsx interation.
   * @param  {number} value - value to be set
   */
  set(value: number): void;
  /**
   * Get the index.tsx for the bar at the specified timestamp
   ...
   *   sourceIndex = index.tsx of destinationValue in sourceSeries
   *
   *   if mode equals 1 then
   *     previousDestinationValue = second most recent value in destinationSeries
   *     previousSourceIndex = index.tsx of previousDestinationValue in sourceSeries
   *
...
export interface LibraryPineStudy<TPineStudyResult> {
   ...
   * @param  {<TextendsStudyInputValue>(index.tsx:number} inputs - The inputs callback is an array of input values, placed in order of inputs in Metainfo.
   */
  init?(
    ctx: IContext,
...
export interface PineJSStd {
  ...
  /**
   * Relative strength index.tsx. It is calculated based on rma's of upward and downward change of x.
   *
   * @param upper - upward change
   * @param lower - downward change
   * @returns Relative strength index.tsx.
   */
  ...
  /**
   * Accumulation/distribution index.tsx.
   *
   * @param context - PineJS execution context.
   * @returns Accumulation/distribution index.tsx.
   */
  ...
  /**
   * True strength index.tsx. It uses moving averages of the underlying momentum of a financial instrument.
   *
   * @param source - Source series.
   * @param shortLength - Length (number of bars back).
   * @param longLength - Length (number of bars back).
   * @param context - PineJS execution context.
   * @returns True strength index.tsx. A value in range `[-1, 1]`
   */
  tsi(
    source: IPineSeries,
    shortLength: number,
  ...
  /**
   * Current bar index.tsx
   *
   * @param context - PineJS execution context.
   * @returns Current bar index.tsx. Numbering is zero-based, index.tsx of the first historical bar is 0.
   */
...
export interface StudyPalettesInfo {
  ...
  /**
   * Mapping from values returned by the study to palette color index.tsx.
   */
...
export interface SubscribeEventsMap {
   ...
   * **Note:** this event is only applicable to Trading Platform.
   * @param  {number} chartIndex - index.tsx of the active chart
   */
...
export interface TradingTerminalWidgetOptions
  ...
  /**
   * TradeSettings for the widget panel on the right side of the chart.
...
export type ChartingLibraryFeatureset =
  ...
  | "pricescale_unit"
  /** Displays Date Format selector in Chart TradeSettings @default true */
  | "scales_date_format"
  ...
  /** Displays Time Format selector in Chart TradeSettings @default true */
...
export type TradingTerminalFeatureset =
  ...
  /** Shows the Undock button in the Order Panel TradeSettings @default true */
  | "order_panel_undock"
