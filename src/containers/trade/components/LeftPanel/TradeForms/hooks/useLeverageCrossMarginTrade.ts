...
type UseLeverageCrossMarginTradeParams = {
  direction: DIRECTION_TYPE;
};

export const useLeverageCrossMarginTrade = ({
  direction,
}: UseLeverageCrossMarginTradeParams) => {
  ...
  useEffect(() => {
    ...
    const fetchLeverageData = async () => {
      ...
      try {
        ...
        console.error("Failed to fetch leverage bounds:", err);
